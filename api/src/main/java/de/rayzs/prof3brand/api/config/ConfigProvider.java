package de.rayzs.prof3brand.api.config;
...
public interface ConfigProvider {
     ...
     */
    static File exportResourceFile(
            final Class<?> clazz,
            final String inFilePath
    ) {
        return exportResourceFile(clazz, inFilePath, "");
    }
     ...
     * @param clazz Class of the project whose local resource folder should be chosen. NULL uses this class here instead.
     * @param inFilePath Resource file path.
     * @param outFileDirPath Export file directory path.
     */
    static File exportResourceFile(
            final Class<?> clazz,
            final String inFilePath,
        ...
        try {
            ...
            final File outputFile = new File(
                    "./plugins/ProF3Brand/" + outFileDirPath,
